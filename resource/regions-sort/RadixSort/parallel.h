...
#define parallel_for_swap _Pragma("cilk grainsize = 4000") parallel_for
#define parallel_for_extract _Pragma("cilk grainsize = 256") parallel_for
...
#define parallel_for_extract for 
static int getWorkers() { return 20; }
static void setWorkers(int n) { }
static int getWorkerId() {
    return 1;
}
